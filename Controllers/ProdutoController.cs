...
namespace Prova.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        {
            var viewModel = new CreateProdutoViewModel()
            {
                produto = new Produto(),
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao,imageUrl,Preco,quantity")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao,imageUrl,Preco,quantity")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
